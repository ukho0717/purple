...
export default class SideMenu extends React.Component {
    ...
    componentDidMount = () => {
        ...
        if(window.location.pathname == '/match' || window.location.pathname == '/match_like' || window.location.pathname == 'match_profile'){
            $('#m1').addClass('on');
        }else if(window.location.pathname == '/message' || window.location.pathname == '/message_profile'){
            $('#m2').addClass('on');
        }else if(window.location.pathname == '/worldcup1' || window.location.pathname == '/worldcup2' || window.location.pathname == '/worldcup3' || window.location.pathname == '/Telepathy' || window.location.pathname == '/Telepathy_make_quiz' || window.location.pathname == '/Telepathy_get_quiz' || window.location.pathname == '/find_main' || window.location.pathname == '/find_select' || window.location.pathname == '/find_match' || window.location.pathname == '/gram_main' || window.location.pathname == '/gram_write' || window.location.pathname == '/gram_post' || window.location.pathname == '/board_bad'){
            $('#m3').addClass('on'); 
            if(window.location.pathname == '/worldcup1' || window.location.pathname == '/worldcup2' || window.location.pathname == '/worldcup3'){
                $('#left_menu #slide_box #sub_menu_enter ul a:nth-child(1)').addClass('on');
            }else if(window.location.pathname == '/Telepathy' || window.location.pathname == '/Telepathy_make_quiz' || window.location.pathname == '/Telepathy_get_quiz'){
                $('#left_menu #slide_box #sub_menu_enter ul a:nth-child(2)').addClass('on');
            }else if(window.location.pathname == '/find_main' || window.location.pathname == '/find_select' || window.location.pathname == '/find_match'){
                $('#left_menu #slide_box #sub_menu_enter ul a:nth-child(3)').addClass('on');
            }else if(window.location.pathname == '/gram_main' || window.location.pathname == '/gram_write' || window.location.pathname == '/gram_post'){
                $('#left_menu #slide_box #sub_menu_enter ul a:nth-child(4)').addClass('on');
            }else if(window.location.pathname == '/board_bad'){
    ...
    render(){
        return (
            <>
                ...
                <div id="m_menu">
                    <ul>
                        <li><a href="profile_main.html"><div><i class="fas fa-address-card"></i></div></a></li>
                        <li><a href="match.html"><div><i class="fas fa-heartbeat"></i></div></a></li>
                        <li><a href="match_list"><div><i class="fas fa-comments"></i></div></a></li>
                    ...
                    <ul>
                        <li>
                            <ul id="myprofile">
                                ...
                                <a id="myprofile_btn"><li><div id="myPho"><div></div></div><span>나의 프로필</span></li></a>
