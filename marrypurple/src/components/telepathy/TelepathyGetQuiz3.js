...
const TelepathyGetQuiz3 = ({history, mun, ans, pic, user_nick, my_pic, my_nick, tot_mun, user_id }) => {
    ...
    return(
        <div id="getQuizWrapper">
            <div class="nth_quiz">3번째 질문</div>
            <div class="situation">연애</div>
            <div id="quiz">
            ...
            <div class="answer">
                ...
                <div><input type="submit" value="선택" onClick={() => right(myAns, ans)}/></div>
            </div>
        </div>
    )
}

export default withRouter(TelepathyGetQuiz3);