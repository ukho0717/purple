let Telepathy,User,Matching;_735‍.x([["mun",()=>mun],["ans",()=>ans],["ans3",()=>ans3],["test",()=>test]]);_735‍.w("../../models/telepathy",[["default",["Telepathy"],function(v){Telepathy=v}]]);_735‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_735‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);



       const mun = async ctx=>{
    _735‍.g.console.log('접속유저: ',ctx.state.user);
