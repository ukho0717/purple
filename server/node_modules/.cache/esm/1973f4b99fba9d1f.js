let Telepathy,User,Matching;_9fb‍.x([["mun",()=>mun],["ans",()=>ans],["ans1",()=>ans1],["ans2",()=>ans2],["ans3",()=>ans3]]);_9fb‍.w("../../models/telepathy",[["default",["Telepathy"],function(v){Telepathy=v}]]);_9fb‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_9fb‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);



       const mun = async ctx=>{
    _9fb‍.g.console.log('접속유저: ',ctx.state.user);
