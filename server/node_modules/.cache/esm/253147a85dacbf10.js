let User,Matching;_5da‍.x([["select",()=>select]]);_5da‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_5da‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);


       const select = async ctx=>{
    try{
        _5da‍.g.console.log('접속유저: ',ctx.state.user);
