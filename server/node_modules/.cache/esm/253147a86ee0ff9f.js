let User,Matching;_6ee‍.x([["select",()=>select]]);_6ee‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_6ee‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);


       const select = async ctx=>{
    try{
        _6ee‍.g.console.log('접속유저: ',ctx.state.user);
