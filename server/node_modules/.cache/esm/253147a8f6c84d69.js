let User,Matching;_f6c‍.x([["select",()=>select]]);_f6c‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_f6c‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);


       const select = async ctx=>{
    try{
        _f6c‍.g.console.log('접속유저: ',ctx.state.user);
