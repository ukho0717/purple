let Matching,User,mongoose;_c7c‍.x([["list",()=>list],["like",()=>like],["pass",()=>pass],["sendSuper",()=>sendSuper],["back",()=>back],["checkLikeMe",()=>checkLikeMe],["report",()=>report]]);_c7c‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);_c7c‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_c7c‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);



//매칭 리스트 보여주기
       const list = async ctx=>{
    _c7c‍.g.console.log('접속유저: ',ctx.state.user)
