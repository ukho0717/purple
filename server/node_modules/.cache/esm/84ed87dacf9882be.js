let Matching,User,mongoose;_cf9‍.x([["list",()=>list],["like",()=>like],["pass",()=>pass],["sendSuper",()=>sendSuper],["back",()=>back],["checkLikeMe",()=>checkLikeMe]]);_cf9‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);_cf9‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_cf9‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);



//매칭 리스트 보여주기
       const list = async ctx=>{
    _cf9‍.g.console.log('접속유저: ',ctx.state.user)
