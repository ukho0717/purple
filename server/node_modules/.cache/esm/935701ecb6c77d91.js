let Joi,User,nodemailer;_b6c‍.x([["register",()=>register],["read",()=>read],["login",()=>login],["findpw",()=>findpw],["changePw",()=>changePw],["check",()=>check],["logout",()=>logout],["remove",()=>remove],["profileUpdate",()=>profileUpdate],["addPic",()=>addPic],["snsRegister",()=>snsRegister],["sendmail",()=>sendmail]]);_b6c‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_b6c‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_b6c‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);
...
//비밀번호 수정
  ...
  _b6c‍.g.console.log('로그인유저123', ctx.state);
  // 로그인 상태 확인
  // const { user } = ctx.state;
  const user = await User.findById(ctx.state.user._id);
  _b6c‍.g.console.log(user)
  if (!user) {
    ctx.status = 401;
    return;
  }
...
//메일보내기
  ...
  console.log("메일보내기")
  // const user_email = ctx.request.body.user_email;
  _b6c‍.g.console.log("user메일22"+  ctx.request.body.user_email);
