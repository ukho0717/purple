let Joi,User,nodemailer;_ce3‍.x([["register",()=>register],["read",()=>read],["login",()=>login],["findpw",()=>findpw],["changePw",()=>changePw],["check",()=>check],["logout",()=>logout],["remove",()=>remove],["profileUpdate",()=>profileUpdate],["addPic",()=>addPic],["snsRegister",()=>snsRegister]]);_ce3‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_ce3‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_ce3‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);
...
//비밀번호 수정
  ...
  _ce3‍.g.console.log('로그인유저123', ctx.state);
  // 로그인 상태 확인
  // const { user } = ctx.state;
  const user = await User.findById(ctx.state.user._id);
  _ce3‍.g.console.log(user)
  if (!user) {
    ctx.status = 401;
    return;
  }
