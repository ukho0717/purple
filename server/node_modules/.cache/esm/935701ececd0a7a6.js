let Joi,User;_ecd‍.x([["register",()=>register],["login",()=>login],["findpw",()=>findpw],["changePw",()=>changePw],["check",()=>check],["logout",()=>logout],["profileUpdate",()=>profileUpdate]]);_ecd‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_ecd‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);
...
const schema = Joi.object().keys({
  ...
  try {
    ...
    _ecd‍.g.console.log('접속유저: ',ctx.state.user)
  } catch (e) {
    ctx.throw(500, e);
  }
};
