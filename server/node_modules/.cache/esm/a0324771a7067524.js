let Chat;_a70‍.x([["default",()=>_a70‍.o]]);_a70‍.w("./models/chat",[["default",["Chat"],function(v){Chat=v}]]);//chat 스키마 가져오기
...
const socketEvents = (io)=>{
    io.on('connection', (socket) => { // 웹소켓 연결 시
        ...
        socket.on('login', function(login){
            ...
            _a70‍.g.console.dir(login);
    
            login_ids[login.id] = socket.id;
            socket.login_id = login.id;
    
            _a70‍.g.console.log('접속한 클라이언트 id 갯수 : %d', Object.keys(login_ids).length);
        });
        ...
        socket.on('room', function(room){
            ...
            _a70‍.g.console.dir(room);
            _a70‍.g.console.log(room.commamd);
            ...
            _a70‍.g.console.log('클라이언트로 보낼 데이터 : ' + JSON.stringify(output));
