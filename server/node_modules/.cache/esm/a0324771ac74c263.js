let Chat;_ac7‍.x([["default",()=>_ac7‍.o]]);_ac7‍.w("./models/chat",[["default",["Chat"],function(v){Chat=v}]]);//chat 스키마 가져오기
...
const socketEvents = (io)=>{
    io.on('connection', (socket) => { // 웹소켓 연결 시
        ...
        socket.on('room', function(room){
            ...
            _ac7‍.g.console.dir(room);
            _ac7‍.g.console.log(room.commamd);
            ...
            _ac7‍.g.console.log('클라이언트로 보낼 데이터 : ' + JSON.stringify(output));
