let Chat;_cbc‍.x([["default",()=>_cbc‍.o]]);_cbc‍.w("./models/chat",[["default",["Chat"],function(v){Chat=v}]]);//chat 스키마 가져오기
...
const socketEvents = (io)=>{
    io.on('connection', (socket) => { // 웹소켓 연결 시
        ...
        socket.on('room', function(room){
            ...
            _cbc‍.g.console.dir(room);
            _cbc‍.g.console.log(room.commamd);
            ...
            _cbc‍.g.console.log('클라이언트로 보낼 데이터 : ' + JSON.stringify(output));
