let Chat;_d44‍.x([["default",()=>_d44‍.o]]);_d44‍.w("./models/chat",[["default",["Chat"],function(v){Chat=v}]]);//chat 스키마 가져오기
...
const socketEvents = (io)=>{
    io.on('connection', (socket) => { // 웹소켓 연결 시
        ...
        socket.on('room', function(room){
            ...
            _d44‍.g.console.dir(room);
            _d44‍.g.console.log(room.commamd);
            ...
            _d44‍.g.console.log('클라이언트로 보낼 데이터 : ' + JSON.stringify(output));
