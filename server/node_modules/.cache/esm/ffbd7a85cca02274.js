let User,Matching,Chat;_cca‍.x([["chatUser",()=>chatUser],["getUserById",()=>getUserById],["getChatInfo",()=>getChatInfo]]);_cca‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_cca‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);_cca‍.w("../../models/chat",[["default",["Chat"],function(v){Chat=v}]]);



       const chatUser = async ctx=>{
        _cca‍.g.console.log('접속유저: ',ctx.state.user)
